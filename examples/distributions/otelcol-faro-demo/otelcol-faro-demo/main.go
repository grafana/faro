...
// Program otelcol-faro-demo is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		Command:     "otelcol-faro-demo",
		Description: "Demo OTel Collector distribution for with Faro components",
		Version:     "0.1.0",
	}
