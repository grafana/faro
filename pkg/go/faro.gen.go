...
type Action struct {
	...
	// Name Action name (e.g. `click`, `submit`)
	Name string `json:"name,omitempty"`

	// ParentID Parent action ID for nested actions
...
type Browser struct {
	// Brands Browser brand list; either a string or an array of Brand objects
	Brands Browser_Brands `json:"brands,omitempty"`

	// Language Browser language
	Language string `json:"language,omitempty"`

	// Mobile Whether the browser is on a mobile device
...
// Browser_Brands Browser brand list; either a string or an array of Brand objects
...
type Event struct {
	...
	// Attributes Arbitrary event attributes
...
type Exception struct {
	...
	// Timestamp Time the exception was captured
	Timestamp time.Time `json:"timestamp"`

	// Trace holds trace id and span id associated to an entity (log, exception, measurement...).
	Trace TraceContext `json:"trace,omitempty"`

	// Type Exception class or type name
...
type Frame struct {
	...
	// Filename Source file name or URL
...
type Geo struct {
	// ASNID ASN identifier
	ASNID string `json:"asn_id,omitempty"`

	// ASNOrg ASN organisation name
	ASNOrg string `json:"asn_org,omitempty"`

	// City City name
	City string `json:"city,omitempty"`

	// ContinentISOCode Continent ISO code
	ContinentISOCode string `json:"continent_iso,omitempty"`

	// CountryISOCode Country ISO 3166-1 alpha-2 code
	CountryISOCode string `json:"country_iso,omitempty"`

	// SubdivisionISO Subdivision / state ISO code
...
type Log struct {
	...
	// Timestamp Time the log was captured
	Timestamp time.Time `json:"timestamp"`
...
type Measurement struct {
	...
	// Timestamp Time the measurement was captured
	Timestamp time.Time `json:"timestamp,omitempty"`
...
type Overrides struct {
	// GeoLocationTrackingEnabled Whether geo-location tracking is enabled for this session
	GeoLocationTrackingEnabled *bool `json:"geoLocationTrackingEnabled,omitempty"`

	// ServiceName Override the service name for this session
	ServiceName string `json:"serviceName,omitempty"`
}

// Page holds metadata about the web page event originates from.
type Page struct {
	// Attributes Arbitrary page attributes
	Attributes map[string]string `json:"attributes,omitempty"`
...
type Payload struct {
	// Events Custom RUM events
	Events []Event `json:"events,omitempty"`

	// Exceptions Captured exceptions / errors
	Exceptions []Exception `json:"exceptions,omitempty"`

	// Logs Log messages
	Logs []Log `json:"logs,omitempty"`

	// Measurements Custom numeric measurements
...
// SDK holds metadata about the app agent that produced the event.
type SDK struct {
	// Integrations Active SDK integrations/plugins
	Integrations []SDKIntegration `json:"integrations,omitempty"`

	// Name SDK name (e.g. `@grafana/faro-web-sdk`)
	Name string `json:"name,omitempty"`
...
type Stacktrace struct {
	// Frames Ordered list of stack frames (innermost first)
...
type TraceContext struct {
	// SpanID OTel span ID (hex-encoded)
	SpanID string `json:"span_id"`

	// TraceID OTel trace ID (hex-encoded)
...
// User holds metadata about the user related to an app event.
type User struct {
	// Attributes Arbitrary user attributes
	Attributes map[string]string `json:"attributes,omitempty"`
