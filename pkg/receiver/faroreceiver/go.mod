module github.com/grafana/faro/pkg/receiver/faroreceiver

go 1.23.3

require (
	github.com/grafana/faro/pkg/go v0.0.0-20250124090506-63d620100884
	github.com/grafana/faro/pkg/translator/faro v0.0.0-20250124090506-63d620100884
